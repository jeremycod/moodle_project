...
/**
 * project restore task that provides all the settings and steps to perform one
...
class restore_project_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('PAGEVIEWBYID', '/mod/project/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('PAGEINDEX', '/mod/project/index.php?id=$1', 'course');
     ...
     * project logs. It must return one array
